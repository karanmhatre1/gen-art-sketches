...
var startPointX = (canvasWidth/3)-Math.random()*(canvasWidth*0.66);
var startPointY = (canvasHeight/3)-Math.random()*(canvasHeight*0.66);
...
for(i=0;i<lineCount;i++) {
  x[i] = (canvasWidth/2)-startPointX;
  y[i] = (canvasHeight/2)-startPointY;
}
...
view.onFrame = function(e) {
  ...
  if(TimeCounter>count+50) {
    ...
    startPointX = (canvasWidth/3)-Math.random()*(canvasWidth*0.66);
    startPointY = (canvasHeight/3)-Math.random()*(canvasHeight*0.66);
